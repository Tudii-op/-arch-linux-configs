#!/usr/bin/env bash
# ML4W Theme Sakura (pink/purple, follows the wallpaper)

# Set waybar
echo "/ml4w-sakura;/ml4w-sakura/default" > $HOME/.config/ml4w/settings/waybar-theme.sh
$HOME/.config/waybar/launch.sh &

# Set swaync
echo '@import "themes/sakura/style.css";' > $HOME/.config/swaync/style.css
swaync-client -rs
